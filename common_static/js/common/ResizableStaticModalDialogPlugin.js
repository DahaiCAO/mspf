...
;(function (undefined) {
    ...
    var defaults = {
        ...
        size: "", // extra_large, large, normal(default), small
        title : "对话框",
        icon : "",
    ...
    var ResizableStaticModalDialogPlugin = function (element, options) {
        this._id = "ResizableStaticModalDialogPlugin";
        this._plugin_name = "Common resiezable static modal dialog";
        this._author = "cdh";
        this._datetime = "20210729";
        this._description = "静态可伸缩的对话框插件";
        this._version = "2.0";
    ...
    ResizableStaticModalDialogPlugin.prototype = {
    ...
    if (typeof module !== "undefined" && module.exports) {
        module.exports = ResizableStaticModalDialogPlugin;
    } else if (typeof define === "function" && define.amd) {
        define(function(){ return ResizableStaticModalDialogPlugin; });
    } else {
        !("ResizableStaticModalDialogPlugin" in _global) && (_global.ResizableStaticModalDialogPlugin = ResizableStaticModalDialogPlugin);
    }
})();